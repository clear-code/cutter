...
#define DEFAULT_DELETED_MARK_COLOR CUT_CONSOLE_COLOR_GREEN
#define DEFAULT_INSERTED_MARK_COLOR CUT_CONSOLE_COLOR_RED
#define DEFAULT_DELETED_LINE_COLOR CUT_CONSOLE_COLOR_GREEN
#define DEFAULT_INSERTED_LINE_COLOR CUT_CONSOLE_COLOR_RED
