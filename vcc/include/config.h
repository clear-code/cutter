...
/* Define to 1 if you have cairo PDF backend installed */
...
/* Define to 1 if you have goffice installed */
/* #undef HAVE_GOFFICE */
...
/* Define to 1 if you have Pango cairo supprot installed */
...
/* #undef NEED_ENVIRON_DECLARATION */
