...
CentOS 5:
  ...
  % wget http://downloads.sourceforge.net/cutter/centos/cutter-release-1.1.0-0.noarch.rpm
  % rpm -Uvh cutter-release-1.1.0-0.noarch.rpm


CentOS 6:

  % sudo rpm -Uvh http://downloads.sourceforge.net/cutter/centos/cutter-release-1.1.0-0.noarch.rpm
